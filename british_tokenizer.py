...
token_exprs = [
    ...
    (r'(\*)',                    MulToken),
    (r'(\/)',                    DivToken),
    (r'(less than or equals with)',                    LessEqualToken),
    (r'(more than or equals with)',                    MoreEqualToken),
    (r'(equals with)',        EqualToken),
    (r'(less than)',          LessToken),
    (r'(larger than)',       MoreToken),
    (r'(not equals with)',     RESERVED),
    (r'(=/=)',                   RESERVED),
    (r'(and)',                   RESERVED),
    (r'(or perhaps)',                    OrToken),
    (r'(not)',                   RESERVED),
    (r'(is)',                   IsToken),
    (r'(then please:(\n)+)',     ThenToken),
