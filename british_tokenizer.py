...
token_exprs = [
    ...
    (r'(\*)',                    MulToken),
    (r'(\/)',                    DivToken),
    (r'(is less than or equals with)',                    LessEqualToken),
    (r'(is more than than or equals with)',                    MoreEqualToken),
    (r'(is equals with)',        EqualToken),
    (r'(is less than)',          LessToken),
    (r'(is greater than)',       MoreToken),
    (r'(isn't equals with)',     RESERVED),
    (r'(=/=)',                   RESERVED),
    (r'(and)',                   RESERVED),
    (r'(or)',                    OrToken),
    (r'(not)',                   RESERVED),
    (r'(is)',                    IsToken),
    (r'(then please:(\n)+)',     ThenToken),
    (r'(carry on whilst)',       LoopToken),
    (r'(list)',                  RESERVED),
    (r'(with(\n)+)',             WithToken),
    (r'(starting)',              StartingToken),
    (r'(otherwise:(\n)+)',       OtherwiseToken),
    (r'(mutter)',                ShowToken),
    (r'(stop that)',             StopToken),
    (r'(cheerio(\n)*)',          EndToken),
    (r'(to)',                    ToToken),
    (r'(using)',                 UsingToken),
    (r'(randomise)',             RandomToken),
    (r'(how many)',             NumberPromptToken),
    (r'(whats that)',           StringPromptToken),
